...
The built-in generator currently creates villages, but not the other vanilla structures: mineshafts, ancient cities, trial chambers, trail ruins, outposts, mansions, monuments, shipwrecks, ocean ruins, ruined portals, desert wells, or fossils. Bastions and End cities additionally require Nether/End dimensions, which GoCraft does not generate yet. Pre-generating a world with vanilla/Paper is the supported way to use those structures today.
